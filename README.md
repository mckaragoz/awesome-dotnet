...
* [UltimateAuth](https://github.com/CodeBeamOrg/UltimateAuth) - A modern unified auth framework for .NET that combines sessions, cookies and tokens into a single model.
